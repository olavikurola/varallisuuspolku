...
const TOUR_STEPS = [
  ...
  { t: 'Elinkaarigraafi ja piirtopöytä', s: '#chartWrap',
    x: 'Viiva on tyypillinen kehitys ja vyöhyke markkinoiden vaihteluväli tuhansista poluista. ⛶ (tai F) avaa piirtopöydän: tartu käyrään, tapahtumaan tai eläkeikäviivaan ja vedä — kone laskee joka vedon hinnan.' },
  { t: 'Kysymykset', s: '#qChips', opt: true,
    x: 'Yhden napautuksen "mitä jos": eläkkeelle 60, työttömyys, lapsi… Haamukäyrä näyttää eron ja Ctrl+Z palauttaa.' },
  { t: 'Elämäntapahtumat ja työeläke', s: '.card[data-card="events"]',
    x: 'Raahaa tapahtuma graafille tai napauta sitä: asunto, lapsi, perintö… Eläkkeelle jäänti -tapahtumasta lisäät työeläkkeesi — vaikuttavin yksittäinen tieto.' },
